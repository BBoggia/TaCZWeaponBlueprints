...
import com.gamergaming.taczweaponblueprints.compat.fzzy_config.ResearchTreeClientConfig;
...
public class ModConfigs {
    ...
    public static final BlueprintConfig BLUEPRINT = register(BlueprintConfig::new, RegisterType.BOTH);
    public static final ResearchTreeClientConfig RESEARCH_TREE_CLIENT =
            register(ResearchTreeClientConfig::new, RegisterType.CLIENT);
